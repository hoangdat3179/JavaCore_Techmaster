...
public class Main {
    public static void main(String[] args) {
        ...
        int month = 11;
        int dayOfMonth = 12;
        LocalDate currenDate = LocalDate.of(year, month, dayOfMonth);
        ...
        System.out.println("Sau 1 tiếng nữa: " + now.plusHours(1));
        System.out.println("Sau 55 phút nữa: " +now.plusMinutes(70));

        System.out.println("Giảm 2 tiếng: " +now.minusHours(2));

        System.out.println("Lấy giờ hiện tại: " +now.getHour());
        System.out.println("Lấy phút hiện tại: " +now.getMinute());

        LocalTime time = LocalTime.of(21, 30, 12);
        System.out.println("Thời gian chỉ định: " +time);

        LocalDateTime dateTime = LocalDateTime.now();
        System.out.println("Ngày và giờ hiện tại: " +dateTime);
        LocalDateTime dateTime2 = LocalDateTime.of(date, time);
        System.out.println("Ngày và giờ chỉ định: " +dateTime2);
        ...
        System.out.println(dateTime3.format(myFormatDateTime));
